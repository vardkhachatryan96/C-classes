...
namespace TrainingsSystemAT
{
    internal class ConsoleHost
    {
        ...
        internal void Run()
        {
            ...
            var englishStudentsList = this.GetAllStudentsByDisciplineName("English");
            ...
            var cSharpStudentsList = this.GetAllStudentsByDisciplineName("English");
        ...
        private IEnumerable<Student> GetAllStudentsByDisciplineName(string disciplineName)
        {
            return this._studentsController.GetAllStudentsByDisciplineName(disciplineName);
        }
